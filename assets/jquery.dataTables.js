...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
      ...
      var extra = {};
      if (aData.length == (oSettings.aoColumns.length + 1)) {
        extra = aData.pop();
      }
      ...
      if (extra.link) {
        $(nTr).attr('data-link', extra.link);
      }
      $(nTr).data('extra', extra);
      ...
      sValue += ',"filterriffic": ' + Filterriffic.cookieData();
        ...
        Filterriffic.loadState(oData.filterriffic)
